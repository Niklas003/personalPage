...
<template>
    <div class="text-center text-lg mx-1.5">
        ...
        <span v-if="site != 'Platforms'" class="inter-light hover:text-slate-400 transition duration-200 cursor-pointer"> <RouterLink to="/platforms"> Platforms </RouterLink></span><span v-if="site != 'Contact'" class="inter-light">|</span>
